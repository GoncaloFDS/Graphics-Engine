...
void Engine::createTangram() {
	...
	checkpoint1.push_back(NodeState(Vec3(-3, 0, 0.5), Quat(-PI / 2, Vec4(0, 0, 1, 1)).Normalize()));
	checkpoint1.push_back(NodeState(Vec3(-3.4, 0.15, 1), Quat(5 * PI / 4, Vec4(0, 0, 1, 1)).Normalize()));
